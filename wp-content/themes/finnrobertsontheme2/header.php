...
<head id="<?php echo of_get_option('meta_headid'); ?>" data-template-set="html5-reset-wordpress-theme">
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/_/inc/bootstrap/css/bootstrap.min.css" />
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/_/inc/bootstrap/css/bootstrap-theme.min.css" />
...
<body <?php body_class(); ?>>
	...
	<nav id="nav" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>">Finn Robertson</a>
	        </div>
	        <div class="navbar-collapse collapse">
				<?php //wp_nav_menu( array('menu' => 'primary', 'menu_class' => 'nav navbar-nav') ); ?>
				<?php 
					wp_nav_menu( array(
	...
	<div class="container theme-showcase">
		...
		<div class="mobile_menu_button glyphicon glyphicon-align-justify"></div>
